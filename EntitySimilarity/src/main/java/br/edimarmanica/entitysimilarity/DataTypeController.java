...
public class DataTypeController {
     ...
     */
    public static DataType getMostFrequentType(Map<String, String> ruleValues) {
        Map<DataType, Integer> dataTypes = new HashMap<>();
        for (String value : ruleValues.values()) {
     ...
     * rule
     */
    public static DataType getMostSpecificType(Map<String, String> r1, Map<String, String> r2) {
        /**
         * Hieraquia
         */
